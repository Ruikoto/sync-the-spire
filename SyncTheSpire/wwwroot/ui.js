...
const GAME_ICONS = {
    sts2: (size = 14) => `<img class="game-icon-img" src="http://assets.local/sts2.png" style="width:${size}px;height:${size}px;object-fit:contain;image-rendering:pixelated;" />`,
    stardew: (size = 14) => `<img class="game-icon-img" src="http://assets.local/sv.png" style="width:${size}px;height:${size}px;object-fit:contain;image-rendering:pixelated;" />`,
    minecraft: (size = 14) => `<img class="game-icon-img" src="http://assets.local/mc.png" style="width:${size}px;height:${size}px;object-fit:contain;image-rendering:pixelated;" />`,
